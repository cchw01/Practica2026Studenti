...
export class ItemService {
  ...
  private mapResponse(item: any): AuctionItem {
    return {
      ...
      Owner: item.owner || { ID: String(item.ownerId), UserName: item.ownerUserName, Name: item.ownerUserName },
      OwnerId: item.ownerId,
      Winner: item.winner || (item.winnerId ? { ID: String(item.winnerId), UserName: item.winnerUserName, Name: item.winnerUserName } : undefined),
