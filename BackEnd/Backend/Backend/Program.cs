...
// ==========================================
// INITIALIZARE & SEEDING BAZĂ DE DATE
// ==========================================
using (var scope = app.Services.CreateScope())
{
    var dbContext = scope.ServiceProvider.GetRequiredService<ApplicationDbContext>();

    // 1. Executare Scripturi SQL de Migrare Manuală
    try
    {
    ...
    // 4. Seedeurs Clasice
    try { DbSeeder.Seed(dbContext); } catch { }
    try { DbInitializer.Seed(dbContext); } catch { }
}
