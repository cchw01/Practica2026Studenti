        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReportedAuctionItemId = table.Column<int>(type: "int", nullable: true),
                    ReportedForumPostId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reports_AuctionItems_ReportedAuctionItemId",
                        column: x => x.ReportedAuctionItemId,
                        principalTable: "AuctionItems",
                        principalColumn: "ID");
                    table.ForeignKey(
                        name: "FK_Reports_ForumPosts_ReportedForumPostId",
                        column: x => x.ReportedForumPostId,
                        principalTable: "ForumPosts",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reports_ReportedAuctionItemId",
                table: "Reports",
                column: "ReportedAuctionItemId");

            migrationBuilder.CreateIndex(
                name: "IX_Reports_ReportedForumPostId",
                table: "Reports",
                column: "ReportedForumPostId");
