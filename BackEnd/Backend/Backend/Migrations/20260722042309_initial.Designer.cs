...
namespace Backend.Migrations
{
    ...
    [Migration("20260722042309_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Models.Report", b =>
                {
                    ...
                    b.Property<int?>("ReportedAuctionItemId")
                        .HasColumnType("int");

                    b.Property<int?>("ReportedForumPostId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ReportedAuctionItemId");

                    b.HasIndex("ReportedForumPostId");
            ...
            modelBuilder.Entity("Backend.Models.Report", b =>
                {
                    b.HasOne("Backend.Models.AuctionItem", "ReportedAuctionItem")
                        .WithMany()
                        .HasForeignKey("ReportedAuctionItemId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Backend.Models.ForumPost", "ReportedForumPost")
                        .WithMany()
                        .HasForeignKey("ReportedForumPostId")
                        .OnDelete(DeleteBehavior.NoAction);
                    ...
                    b.Navigation("ReportedAuctionItem");

                    b.Navigation("ReportedForumPost");
